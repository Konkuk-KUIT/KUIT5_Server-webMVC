        ...
        <div class="col-md-3 text-end">
            <c:choose>
                <c:when test="${not empty sessionScope.user}">
                    ...
                    <a href="/user/update_form?userId=${sessionScope.user.userId}" role="button" class="btn btn-primary" >개인정보수정</a>
                </c:when>
                <c:otherwise>
        ...
        <article class="article">
            ...
            <div class="article-util">
                <ul class="article-util-list">
                    ...
                    <li><a class="link-modify-article" href="../home.jsp">목록</a></li>
                </ul>
            </div>
        </article>
